<?php			
			...
			$language_array = array ("ru","ua","eng");
//array menus categoriys			
			$array_trips = set_array_trips();
						
			if(!isset($array_trips)){
				$array_trips = array("Египет","Животные","Птицы","Портреты");//Нужно заполнять вручную, работает в случае отказа б/д
			}
//array menus pages	
			$array_menus = set_array_pages(); 
			if(!isset($array_menus)){
				$array_menus = array("about" => "ОБО МНЕ", "contact" => "КОНТАКТЫ", "copyright" => "COPYRIGHT");
			}
// vars for main settings
			$array_settings = set_array_settings('ru');
			
//socials
			$nav_copyright = "copyright";///???
			$array_socials_class = array(
													"Facebook" => "social facebook",
													"Instagram" => "social instagram",
													"Linkedin" => "social linkedin",
													"Twitter" => "social twitter"
											);
			$array_socials_linc = array(
													"Facebook" => "https://www.facebook.com/constantin.vidyuschenko",
													"Instagram" => "https://www.instagram.com/constantinvvdyuschenko/",
													"Linkedin" => "https://www.linkedin.com/feed/?trk=homepage-basic_signin-form_submit",
													"Twitter" => "https://twitter.com/i/connect_people"
											);
			$array_socials_box = array(
													"Facebook" => "0 0 320 512",
													"Instagram" => "0 0 448 512",
													"Linkedin" => "0 0 448 512",
													"Twitter" => "0 0 512 512"
											);
			$array_socials_color = array(
