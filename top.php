		...
		<div class="rigtn_up">
			<span class="iconSearch"><input class="searchInput" type="text" placeholder="Поиск"><i id="search" class="fa fa-search" aria-hidden="true" title="Поиск по сайту"></i>&#149</span>
